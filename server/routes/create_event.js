...
module.exports = function(req, res) {
  ...
  db.one('INSERT into EVENTS (owner, title, short_desc, description, location, date, time, min) VALUES (${owner}, ${title}, ${short_desc}, ${description}, ${location}, ${date}, ${time}, ${min}) returning event_id', event)
  .then( (result) => {
