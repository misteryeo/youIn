...
class Facebook extends React.Component {
  ...
  componentDidMount() {
    window.fbAsyncInit = function() {
      FB.init({
        appId      : window.location.host === 'localhost:8080' ? '1678389805794701' : window.location.host === 'you-in.herokuapp.com' ? '1724251701198619' :'414888392204388',
        cookie     : true,  // enable cookies to allow the server to access
                          // the session 1286128124802062
        xfbml      : true,
        version    : 'v2.1'
      });
